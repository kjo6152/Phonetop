...
public class ConnectivityManager {
    ...
    public NetworkInfo getActiveNetworkInfo() {
        try {
        	if (PhonetopTetheringManager.isReverseTethering()) {
				Log.i("ConnectivityManager","getActiveNetworkInfo");
				return PhonetopTetheringManager.getNetworkInfo();
			}
    ...
    public NetworkInfo getNetworkInfo(int networkType) {
    	try {
        	if (networkType == TYPE_WIFI && PhonetopTetheringManager.isReverseTethering()) {
				Log.i("ConnectivityManager","getActiveNetworkInfo");
				return PhonetopTetheringManager.getNetworkInfo();
			}
