 ...
 * </p>
 */
final class UsbDisplayAdapter extends DisplayAdapter {
    private static final String TAG = "UsbDisplayAdapter";
    ...
    private UsbDisplayController mDisplayController;
    ...
    public UsbDisplayAdapter(DisplayManagerService.SyncRoot syncRoot,
            Context context, Handler handler, Listener listener,
            PersistentDataStore persistentDataStore) {
        super(syncRoot, context, handler, listener, TAG);
        Slog.d(TAG, "UsbDisplayAdapter");
    ...
    public void registerLocked() {
        ...
        getHandler().post(new Runnable() {
            @Override
            public void run() {
                mDisplayController = new UsbDisplayController(
    ...
    public void requestConnectLocked(final String address) {
    	Slog.d(TAG, "requestConnectLocked");
...
//                    mDisplayController.requestResume();
    ...
    private final UsbDisplayController.Listener mWifiDisplayListener =
            new UsbDisplayController.Listener() {
         @Override
    ...
    private final class WifiDisplayDevice extends DisplayDevice {
        ...
        public WifiDisplayDevice(IBinder displayToken, String name,
                ...
                Surface surface) {
            super(UsbDisplayAdapter.this, displayToken);
            mName = name;
            mWidth = width;
            mHeight = height;
