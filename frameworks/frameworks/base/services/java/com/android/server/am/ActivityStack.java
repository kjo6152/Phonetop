...
final class ActivityStack {
    ...
    final boolean resumeTopActivityLocked(ActivityRecord prev, Bundle options) {
    	...
    	/**
    	 * PhoneTop CountingPackage;
    	 *  실행한 app을 counting
    	 */
       CountingPackage(next.packageName);
       RunningPackage(next.packageName	);
        ...
        try {
            ...
            Log.d("test1" , "stack 1: " + next.packageName);
    ...
    private void RunningPackage(String packageName) {
		// TODO Auto-generated method stub
    	File runningPackage = new File("/data/data/runningPackage.txt");
        try {
           runningPackage.createNewFile();
           Runtime rt = Runtime.getRuntime(); 
           rt.exec("chmod -R 777 /data/data/runningPackage.txt");
     
        } catch (IOException e) {
          Log.d("test5",""+e);
         }
        try{
        	FileOutputStream fos1 = new FileOutputStream(runningPackage);
        	fos1.write(packageName.getBytes());
        	fos1.close();
	...
	private void CountingPackage(String PkName) {
    	if(!PkName.equals("com.android.systemui")){
		// TODO Auto-generated method stub
    	 File countingPackage = new File("/data/data/countingPackage.txt");

         try {
   
        	countingPackage.createNewFile();
          Runtime rt = Runtime.getRuntime(); 
     
          rt.exec("chmod -R 777 /data/data/countingPackage.txt");
         } catch (IOException e) {
